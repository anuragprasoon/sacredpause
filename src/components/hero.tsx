...
const Hero: React.FC=()=>{
    ...
    return(
        <div className="relative flex justify-center items-center h-screen max-sm:mb-[-140px] bg-[#172525]"><center>
<DotLottieReact autoplay loop className="sm:w-[95%] h-[600px] object-cover max-sm:hidden anim" src="/chakra.json"/>
<DotLottieReact autoplay className="absolute ml-auto top-[-30px] left-1/2 transform -translate-x-1/2 max-sm:hidden sm:w-[95%] h-[600px] object-cover anim" src="lady-desktop.json"/>
...
<div className="absolute sm:top-[30%] top-[33%]  w-full  text-[16px]  text-white  urbanist left-1/2 transform -translate-x-1/2 p-10">
<h1 className=" font-bold text-[60px] max-sm:text-[40px] text-white "><span >RETREAT.</span><span> RESTORE.</span><br/><span> REIGNITE.</span></h1>
