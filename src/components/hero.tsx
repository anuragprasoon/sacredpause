...
<DotLottieReact autoplay loop className="sm:w-[95%] h-[600px] object-cover anim" src="/chakra.json"/>
<DotLottieReact autoplay className="absolute ml-auto top-0 left-1/2 transform -translate-x-1/2 sm:w-[95%] h-[600px] object-cover anim" src="/lotus opening.json"/>
