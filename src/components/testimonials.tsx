...
const Testimonial: React.FC<{}>=()=>{
    return(
        ...
        <h3 className="text-[40px] font-bold text-black text-center">What our people says</h3>
    <div className="flex overflow-x-auto justify-center">

<div className="p-10 mt-10">
<div className="urbanist w-[300px] bg-[#E8E8EB] text-center text-black p-10 border-[0px] rounded-xl border-[#2E524A]">
	<Image alt="Anurag Prasoon" className="ml-auto mr-auto mb-5 mt-[-80px] w-[80px] h-[80px] rounded-full object-cover" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478606/sacred-pause-com/lo7gokokci9xmqb1drig.png"/>
