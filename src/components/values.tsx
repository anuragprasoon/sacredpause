...
const Value: React.FC<{}>=()=>{
    return(
        <div className="sm:flex justify-center bg-white p-10">
            <img className="w-full sm:absolute p-10 sm:hidden" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750633443/sacred-pause-com/cyptm2gz8cbkyczdwgls.png"/>

<div className="bg-[#E8E8EB]">
<div className="sm:mr-[100px] text-[#171612]">

<div className="urbanist max-sm:w-full  p-5 flex items-center">
...
<img className="w-[350px] sm:absolute p-2 max-sm:hidden" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750633443/sacred-pause-com/cyptm2gz8cbkyczdwgls.png"/>
...
<div className="urbanist max-sm:w-full   p-5 flex items-center text-right">
  	<div>
