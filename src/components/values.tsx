  ...
  AOS.init({ duration: 1500 });
    ...
    return(
        <div className="sm:flex justify-center bg-white p-10 overflow-x-hidden">
            <img alt="Sacred Pause" data-aos="fade-up" className="w-full sm:absolute p-10 sm:hidden" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750633443/sacred-pause-com/cyptm2gz8cbkyczdwgls.png"/>
...
<div className="urbanist max-sm:w-full  p-5 flex items-center" data-aos="fade-right">
    <img alt="Svādhyāya" className=" bg-white rounded-full w-[80px] p-5 m-3" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478607/sacred-pause-com/auvyzswhqnr8gyncycib.svg"/>
  	<div>
...
<div className="urbanist max-sm:w-full   p-5 flex items-center " data-aos="fade-right">
    <img alt="प्राण आहार (Prāṇa Āhāra) Food as Prana" className=" bg-white rounded-full w-[80px] p-5 m-3" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478607/sacred-pause-com/fzaremcj7ibj7eckjujs.svg"/>
  	<div>
...
<div className="urbanist max-sm:w-full  p-5 flex items-center " data-aos="fade-right">
    <img alt="अन्तर्मुखी यात्रा (Antarmukhī Yātrā) Journey Inward" className=" bg-white rounded-full w-[80px] p-5 m-3" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478608/sacred-pause-com/fegsseogtxg6itvxhgns.svg"/>
  	<div>
...
<img alt="Sacred Pause" data-aos="fade-down" className="w-[350px] sm:absolute p-2 max-sm:hidden " src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750633443/sacred-pause-com/cyptm2gz8cbkyczdwgls.png"/>
...
<div className="urbanist max-sm:w-full   p-5 flex items-center text-right " data-aos="fade-left">
    ...
    <img alt="साधना (Sādhanā) Stillness as Practice" className=" bg-white rounded-full w-[80px] p-5 m-3" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478606/sacred-pause-com/gy3p5tab55ssrxhzgdao.svg"/>
</div>
...
<div className="urbanist max-sm:w-full  p-5 flex items-center text-right " data-aos="fade-left">
    ...
    <img alt="संस्कार (Saṃskāra) Rituals of Connection" className=" bg-white rounded-full w-[80px] p-5 m-3" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478607/sacred-pause-com/z4pvc4tprqzwlasayzek.svg"/>
</div>
</div>
