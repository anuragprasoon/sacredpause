...
<Image alt="Morning Yoga" className="w-[200px] h-[200px] object-cover rounded" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478607/sacred-pause-com/nuqph0eifartcwkubtme.png"/>
<span className=" hidden text-white md:text-black text-[20px] absolute bottom-10 text-center w-full p-3">Morning Yoga</span>
</div>

<div className=" w-[200px] h-[200px] rounded-full urbanist mb-10 " data-aos="fade-left">
<Image alt="Meditative walks" className="w-[200px] h-[200px] object-cover rounded" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478606/sacred-pause-com/v3dbtklnnukf6x8lrvir.png"/>
<span className="hidden text-white md:text-black text-[20px] absolute bottom-10 text-center w-full p-3">Meditative walks</span>
</div>

<div className=" w-[200px] h-[200px] rounded-full urbanist mb-10 "data-aos="fade-left">
<Image alt="Restorative sessions" className="w-[200px] h-[200px] object-cover rounded" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478606/sacred-pause-com/ihfvqt5lrmvxhd4nzd2z.png"/>
...
<Image alt="Restorative sessions" className=" w-[200px] h-[200px] object-cover rounded" src="https://res.cloudinary.com/anuragprasoon/image/upload/v1750478606/sacred-pause-com/lo7gokokci9xmqb1drig.png"/>
