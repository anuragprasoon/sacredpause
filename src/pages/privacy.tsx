...
export default function Policy() {
  return (
    <>
    <Head>
      <title>Privacy Policy | Sacred Pause</title>
      ...
      <meta property="og:title" content="Privacy Policy | Sacred Pause " />
      ...
      <meta name="twitter:card" content="Privacy Policy | Sacred Pause" />
      <meta name="twitter:title" content="Privacy Policy | Sacred Pause" />
    ...
    <div className="p-10 text-black bg-white">
            <h2 className="urbanist text-[40px] font-bold anim" data-aos="fade-up">Our Privacy Policy</h2>
