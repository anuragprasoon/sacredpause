...
export default function Disclaimer() {
  return (
    <>
    <Head>
      <title>Disclaimer | Sacred Pause</title>
      ...
      <meta property="og:title" content="Disclaimer | Sacred Pause" />
      ...
      <meta name="twitter:card" content="Disclaimer | Sacred Pause" />
      <meta name="twitter:title" content="Disclaimer | Sacred Pause" />
    ...
    <div className="p-10 text-black bg-white">
            ...
            <Image alt="Disclaimer Image" data-aos="fade-up" className="mb-5 mt-5 object-cover h-[300px] w-full rounded anim" src="https://images.pexels.com/photos/3820380/pexels-photo-3820380.jpeg"/> 
...
~
          ...
          <div className="flex mt-5 gap-2 overflow-x-auto bg-[#172525] p-10 rounded">
                <Image alt="Image 1" className="h-[300px] w-[400px] object-cover rounded" src="https://images.pexels.com/photos/1234035/pexels-photo-1234035.jpeg"/>

                <Image alt="Image 2" className="h-[300px] w-[400px] object-cover rounded" src="https://images.pexels.com/photos/3576284/pexels-photo-3576284.jpeg"/>

                <Image alt="Image 3" className="h-[300px] w-[400px] object-cover rounded" src="https://images.pexels.com/photos/906097/pexels-photo-906097.jpeg"/>
            </div>
    </>
  );
}
